...
public class Transform3f {
	 ...
	 * 
	 * @param f focus
	 * @param pPos Plane Position
	 * @param pN Plane Normal
	 * @return
	 */
	public static Transform3f GenerateProjectionToPlaneMatrix(Vertex3f f,Vertex3f pPos,Direction3f pN){
		 ...
		 * 
		 * P' � l'intersezione del piano  (P'-Q)N=0
